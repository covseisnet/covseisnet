...
latex_documents = [
    (master_doc, 'covnet.tex', 'covnet Documentation',
     'Leonard Seydoux and Jean Soubestre', 'manual'),
]
...
man_pages = [
    (master_doc, 'covnet', 'covnet Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'covnet', 'covnet Documentation',
     author, 'covnet', 'Array seismic data processing.',
     'Miscellaneous'),
]
